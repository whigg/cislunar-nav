function plotDayCoverage(pts,covered,i,dt,moon)
%PLOTDAYCOVERAGE Plots one day coverage for a lunar service volume output 
%by coverageLNSP, starting at idx.
%   Inputs: (dims),[units]
%    - pts    ; (3xl),[km] points coverage was evaluated at
%    - covered; (nxl) availability (or not) of l points at n time steps
%    - i      ; (1x1),[N/A] start of day to plot
%    - dt     ; (1x1),[s] time between steps
%    - moon   ; (1x1),[N/A] optional (default false) boolean -- plot moon?

if nargin < 5, moon = false; end

n = floor(86400 / dt) + 1;              % time steps in 1 day
covered = covered(i:(i+n-1),:);         % crop to one day
