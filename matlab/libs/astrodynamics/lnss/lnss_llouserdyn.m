function dxdt = lnss_llouserdyn(t,x,moon,N,earth)
%LNSS_LLOUSERDYN Inertial dynamics for a spacecraft in low lunar orbit
%navigating using an LNSS constellation; state is position, velocity, and
...
dxdt = zeros(9,1);
dxdt(1:6) = orbitaldynamics(t,x(1:6),moon,N,earth);
