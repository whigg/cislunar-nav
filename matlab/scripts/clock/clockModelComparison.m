...
xlabel('Time (hrs)', 'FontSize', fsz);
ylabel('Phase deviation / clock bias error (m)', 'FontSize', fsz);
legend(["Monte-Carlo run", "3\sigma bound"], ...
    'location', 'northwest', 'FontSize', fsz);
title('Microsemi Space CSAC Timing Performance', 'FontSize', fsz);
...
ylabel("3\sigma clock bias error (m)", 'FontSize', fsz);
...
title('Comparison of Clock Timing Performances', 'FontSize', fsz);
